    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('round', models.CharField(choices=[('Q', 'Quarter Final'), ('S', 'Semi Final'), ('F', 'Final'), ('W', 'Winner')], default='Q', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Player',
        ...
        migrations.AddField(
            model_name='game',
            name='guest_team',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='guest', to='bblms.team'),
        ),
        migrations.AddField(
            model_name='game',
            name='host_team',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='host', to='bblms.team'),
        ),
        migrations.AddField(
            model_name='game',
            name='winner',
